      ...
      <main className="editor-main">
        ...
        <div className="editor-toolbar">
          <div className="editor-format-bar">
            <button
              className={`fmt-btn preview-toggle${preview ? ' active' : ''}`}
              title="Предпросмотр"
          ...
          <div className="editor-toolbar-right">
            ...
            <button className="btn-draft" onClick={() => navigate('/feed')}>Черновик</button>
        ...
        <div className="editor-scroll">
          ...
          {/* Title */}
          {preview
            ? <div className="preview-title">{title || 'Без заголовка'}</div>
            : <textarea className="editor-title-input" placeholder="Заголовок статьи..."
